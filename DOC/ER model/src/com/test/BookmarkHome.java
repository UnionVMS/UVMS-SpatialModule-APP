 ...
 * @see com.test.Bookmark*/
public class BookmarkHome {

	private static final Log log = LogFactory.getLog(BookmarkHome.class);
	...
	public Bookmark merge(Bookmark detachedInstance) {
		...
		try {
			Bookmark result = (Bookmark) sessionFactory.getCurrentSession()
	...
	public Bookmark findById(com.test.BookmarkId id) {
		log.debug("getting Bookmark instance with id: " + id);
		try {
			Bookmark instance = (Bookmark) sessionFactory.getCurrentSession()
					.get("com.test.Bookmark", id);
			if (instance == null) {
	...
	public List<Bookmark> findByExample(Bookmark instance) {
		log.debug("finding Bookmark instance by example");
		try {
			List<Bookmark> results = (List<Bookmark>) sessionFactory
					.getCurrentSession().createCriteria("com.test.Bookmark")
