...
public class CountriesHome {
	...
	public Countries merge(Countries detachedInstance) {
		...
		try {
			Countries result = (Countries) sessionFactory.getCurrentSession()
	...
	public List<Countries> findByExample(Countries instance) {
		...
		try {
			List<Countries> results = (List<Countries>) sessionFactory
					.getCurrentSession().createCriteria("com.test.Countries")
