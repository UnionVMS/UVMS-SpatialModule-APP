 ...
 * @see com.test.Databasechangelog
...
public class DatabasechangelogHome {
	...
	public Databasechangelog findById(com.test.DatabasechangelogId id) {
		log.debug("getting Databasechangelog instance with id: " + id);
		try {
			Databasechangelog instance = (Databasechangelog) sessionFactory
					.getCurrentSession().get("com.test.Databasechangelog", id);
			if (instance == null) {
	...
	public List<Databasechangelog> findByExample(Databasechangelog instance) {
		...
		try {
			List<Databasechangelog> results = (List<Databasechangelog>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.test.Databasechangelog")
