 ...
 * @see com.test.Databasechangeloglock*/
public class DatabasechangeloglockHome {
	...
	public Databasechangeloglock findById(int id) {
		...
		try {
			Databasechangeloglock instance = (Databasechangeloglock) sessionFactory
					.getCurrentSession().get("com.test.Databasechangeloglock",
							id);
			if (instance == null) {
	...
	public List<Databasechangeloglock> findByExample(
			Databasechangeloglock instance) {
		log.debug("finding Databasechangeloglock instance by example");
		try {
			List<Databasechangeloglock> results = (List<Databasechangeloglock>) sessionFactory
					.getCurrentSession()
					.createCriteria("com.test.Databasechangeloglock")
