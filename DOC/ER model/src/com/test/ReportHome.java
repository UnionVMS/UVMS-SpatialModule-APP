...
public class ReportHome {
	...
	public Report merge(Report detachedInstance) {
		...
		try {
			Report result = (Report) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Report findById(long id) {
		...
		try {
			Report instance = (Report) sessionFactory.getCurrentSession().get(
					"com.test.Report", id);
			if (instance == null) {
	...
	public List<Report> findByExample(Report instance) {
		...
		try {
			List<Report> results = (List<Report>) sessionFactory
					.getCurrentSession().createCriteria("com.test.Report")
