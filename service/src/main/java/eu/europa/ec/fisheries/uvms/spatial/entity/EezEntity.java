...
public class EezEntity {
    // TODO please use lombok @Data like CountryEntity it would be nice also to use some naming instead of abreviation like eez
    // TODO I give a try and change it to use lombok but that Entity classes are automatically generated by InteliJ plugin so I do not think it is necessary
    // TODO I do not like very long name conventions in code because it make code less readable for me. I am using full name in service (ex. exclusiveEconomicZoneService.getExclusiveEconomicZoneById()) so it is easy to decode full entity name
    private long gid;
