...
public class CountryEntity extends BaseAreaEntity {
	...
	@Id
	@Column(name = "gid")
	@SequenceGenerator(name="SEQ_GEN_countries", sequenceName="countries_seq", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_GEN_countries")
	@JsonProperty("gid")
	private Long id;
