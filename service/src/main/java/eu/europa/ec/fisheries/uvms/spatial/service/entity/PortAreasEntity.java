...
public class PortAreasEntity extends BaseAreaEntity {
	...
	@Id
	@Column(name = "gid")
	@SequenceGenerator(name="SEQ_GEN_port_area", sequenceName="port_area_seq", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_GEN_port_area")
    @JsonProperty("gid")
    private Long id;
