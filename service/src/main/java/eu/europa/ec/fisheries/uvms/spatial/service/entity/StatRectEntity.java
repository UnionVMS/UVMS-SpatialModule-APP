...
public class StatRectEntity extends BaseAreaEntity {
	...
	@Id
	@Column(name = "gid")
	@SequenceGenerator(name="SEQ_GEN_stat_rect", sequenceName="stat_rect_seq", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_GEN_stat_rect")
    @JsonProperty("gid")
    private Long id;
