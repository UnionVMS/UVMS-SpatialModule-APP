...
public class ModuleInitializerBeanTest {
    ...
    public void shouldDeployDescriptor() throws Exception {
        ...
        WireMock.stubFor(WireMock.post(WireMock.urlEqualTo("/usm-administration/rest/authenticate"))
                .willReturn(WireMock.aResponse()
                        ...
                        .withBody("{" +
                                ...
                                " \"statusCode\": 0\n" +
                                "}")));
        WireMock.stubFor(WireMock.get(WireMock.urlEqualTo("/usm-administration/rest/deployments/spatialModule"))
                .willReturn(WireMock.aResponse()
        ...
        WireMock.verify(1, WireMock.getRequestedFor(WireMock.urlEqualTo("/usm-administration/rest/deployments/spatialModule"))
