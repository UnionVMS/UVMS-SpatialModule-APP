...
public abstract class BaseSpatialDaoTest extends BaseDAOTest {
    ...
    protected static final Operation INSERT_REFERENCE_DATA = sequenceOf(
            insertInto("spatial.projection")
                    ...
                    .values(1L, "Spherical Mercator", 3857, "+proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +wktext  +no_defs", "m", "m", true, "20026376.39;-20048966.10;20026376.39;20048966.10", "enu", "20026376.39;-20048966.10;20026376.39;20048966.10")
                    .values(2L, "WGS 84", 4326, "+proj=longlat +datum=WGS84 +no_defs", "dd;dms;ddm;m", "degrees", true, "-180;-90;180;90", "neu", "-180;-90;180;90")
                    .build(),
            ...
            insertInto("spatial.service_layer")
                    ...
                    .values(1L, "EEZ", true, 1, "SYSAREA")
                    .values(2L, "RFMO", true, 1, "SYSAREA")
                    .values(3L, "Countries", true, 1, "SYSAREA")
                    .values(4L, "Ports", true, 1, "SYSAREA")
                    .values(5L, "UserAreas", true, 1, "SYSAREA")
                    .values(6L, "PortAreas", true, 1, "SYSAREA")
                    .values(7L, "bingRoad", false, 1, "background")
                    .build(),
            insertInto("spatial.area_location_types")
                    .columns("ID", "TYPE_NAME", "AREA_DB_TABLE", "IS_LOCATION", "IS_SYSTEM_WIDE", "SERVICE_LAYER_ID")
                    .values(1L, "EEZ", "eez", false, true, 1)
                    .values(2L, "RFMO", "rfmo", false, true, 2)
                    .values(3L, "COUNTRY", "countries", false, false, 3)
                    .values(4L, "PORT", "port", true, true, 4)
                    .values(5L, "USERAREA", "user_areas", false, false, 5)
                    .values(6L, "PORTAREA", "port_area", false, true, 6)
                    .values(7L, "BINGROAD", "NA", false, false, 7)
