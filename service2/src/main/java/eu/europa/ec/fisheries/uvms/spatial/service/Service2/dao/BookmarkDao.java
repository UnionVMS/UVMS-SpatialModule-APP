...
public class BookmarkDao {
    ...
    public List<BookmarkEntity> findAllByUser(String userName)  {

        TypedQuery<BookmarkEntity> query = em.createNamedQuery(BookmarkEntity.LIST_BY_USERNAME, BookmarkEntity.class);
