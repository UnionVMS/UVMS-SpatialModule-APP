...
public class ReportConnectServiceAreasEntity2 implements Comparable<ReportConnectServiceAreasEntity2> {
	...
	private ReportConnectSpatialEntity2 reportConnectSpatial;
	...
	@Override
	public int compareTo(ReportConnectServiceAreasEntity2 reportConnectServiceArea) {
	...
	public ReportConnectSpatialEntity2 getReportConnectSpatial() {
		return reportConnectSpatial;
	}

	public void setReportConnectSpatial(ReportConnectSpatialEntity2 reportConnectSpatial) {
	...
	public boolean equals(Object o) {
		...
		ReportConnectServiceAreasEntity2 that = (ReportConnectServiceAreasEntity2) o;
