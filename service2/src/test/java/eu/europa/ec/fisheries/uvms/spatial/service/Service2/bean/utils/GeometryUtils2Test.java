...
public class GeometryUtils2Test extends TransactionalTests {
    ...
    public void geometryToWktTest(){
        ...
        Geometry geo = GeometryUtils2.createPoint(lat, lon);
        String wkt = GeometryUtils2.geometryToWkt(geo);
    ...
    public void WktToGeometryTest() throws Exception{
        ...
        Point point = (Point) GeometryUtils2.wktToGeometry(wkt);
    ...
    public void pointToWktToPointTest() throws Exception{
        ...
        Point point = (Point) GeometryUtils2.createPoint(lat, lon);
        String wkt = GeometryUtils2.geometryToWkt(point);
        Point wktPoint = (Point) GeometryUtils2.wktToGeometry(wkt);
    ...
    public void WktToCentroidWktTest() throws Exception{
        ...
        String centroidWkt = GeometryUtils2.wktToCentroidWkt(wkt);
        Point centroidPoint = (Point) GeometryUtils2.wktToGeometry(centroidWkt);
